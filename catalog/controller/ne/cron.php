...
class ControllerNeCron extends Controller {
            ...
            switch ($schedule['to']) {
                case 'marketing':
                    ...
                    foreach ($results as $result) {
                        if (isset($schedule['only_selected_language']) && (($language['code'] != $result['language_code'] && $result['language_code']) || (!$result['language_code'] && $language['language_id'] != $this->config->get('config_language_id')))) {
                            continue;
                        }
                ...
                case 'customer':
                    if (isset($schedule['customer']) && $schedule['customer']) {
                        ...
                        foreach ($schedule['customer'] as $customer_id) {
                            ...
                            if ($customer_info) {
                                if (isset($schedule['only_selected_language']) && (($language['code'] != $customer_info['language_code'] && $customer_info['language_code']) || (!$customer_info['language_code'] && $language['language_id'] != $this->config->get('config_language_id')))) {
                                    continue;
                                }
                ...
                case 'affiliate':
                    if (isset($schedule['affiliate']) && $schedule['affiliate']) {
                        ...
                        foreach ($schedule['affiliate'] as $affiliate_id) {
                            ...
                            if ($affiliate_info) {
                                if (isset($schedule['only_selected_language']) && (($language['code'] != $affiliate_info['language_code'] && $affiliate_info['language_code']) || (!$affiliate_info['language_code'] && $language['language_id'] != $this->config->get('config_language_id')))) {
                                    continue;
                                }
    ...
    private function template($schedule) {
        ...
        if ($template) {
            ...
            $this->data['show_saving'] = $template['product_show_savings'];
            ...
            $this->data['saving_color'] = $template['product_savings_color'];
            $this->data['saving_style'] = $template['product_savings_style'];
