...
<div id="content">
    ...
    <div class="box">
        ...
        <div class="content">
            ...
            <form method="post" action="index.php?route=aselsi/aselsi/update&token=<?php echo $_GET['token']; ?>&id=<?php echo $_GET['id']; ?>" id="le_form">
                ...
                <table class="form">
                    <tbody>
                        <tr>
                            ...
                            <td><input type="text" name="title" size="100" value="<?php echo $mission['title']; ?>"></td>
                        </tr>
                        <tr>
                            ...
                            <td><textarea name="msg" id="msg" ><?php echo $mission['msg']; ?></textarea></td>
                        </tr>
                        <tr>
                            <td><span class="required">*</span>Volgorde:</td>
                            <td><input type="text" name="sort" size="2" value="<?php echo $mission['sort']; ?>" /> </td>
                        </tr>
                        <tr>
                            <td><span class="required">*</span>Actief:</td>
                            <td><select name="status">
                                <option value="1" <?php if($mission['status']){echo 'selected="selected"';}?> >Actief</option>
                                <option value="0" <?php if(!$mission['status']){echo 'selected="selected"';}?>>Non-Actief</option>
                            </select></td>
                        </tr>
                    </tbody>
                </table>
