  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
    <table class="form">
      <tr>
        ...
        <td colspan="2"><input type="text" name="sisowfijn_merchantid" value="<?php echo $sisowfijn_merchantid; ?>" />
          <br />
      ...
      <tr>
        ...
        <td colspan="2"><input type="text" name="sisowfijn_merchantkey" value="<?php echo $sisowfijn_merchantkey; ?>" />
          <br />
          <?php if ($error_username) { ?>
          <span class="error"><?php echo $error_username; ?></span>
          <?php } ?></td>
      ...
      <tr>
        ...
        <td colspan="2"><select name="sisowfijn_status_success">
            <?php foreach ($order_statuses as $order_status) { ?>
            <?php if ($order_status['order_status_id'] == $sisowfijn_status_success) { ?>
      ...
      <tr>
        ...
        <td colspan="2"><select name="sisowfijn_testmode">
            <?php if ($sisowfijn_testmode=="true") { ?>
          ...
          <tr>
            ...
            <td colspan="2"><input type="text" name="sisowfijn_total" value="<?php echo $sisowfijn_total; ?>" /></td>
          </tr>          
          <tr>
            <td><?php echo $entry_totalmax; ?></td>
            <td colspan="2"><input type="text" name="sisowfijn_totalmax" value="<?php echo $sisowfijn_totalmax; ?>" /></td>
          </tr>          
        <tr>
          <td><?php echo $entry_geo_zone; ?></td>
          <td><select name="sisowfijn_geo_zone_id">
              <option value="0"><?php echo $text_all_zones; ?></option>
              <?php foreach ($geo_zones as $geo_zone) { ?>
              <?php if ($geo_zone['geo_zone_id'] == $sisowfijn_geo_zone_id) { ?>
      ...
      <tr>
        ...
        <td colspan="2"><select name="sisowfijn_status">
            <?php if ($sisowfijn_status) { ?>
      ...
      <tr>
        ...
        <td colspan="2"><input type="text" name="sisowfijn_sort_order" value="<?php echo $sisowfijn_sort_order; ?>" size="1" /></td>
      </tr>
      <tr>
