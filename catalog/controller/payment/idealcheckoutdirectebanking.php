...
class ControllerPaymentIdealcheckoutdirectebanking extends Controller
{
	public function index() 
	{
		...
		$this->data['continue'] = $this->url->link('payment/idealcheckoutdirectebanking/setup');

		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/idealcheckoutdirectebanking.tpl')) 
		{
			$this->template = $this->config->get('config_template') . '/template/payment/idealcheckoutdirectebanking.tpl';
		}
		else
		{
			$this->template = 'default/template/payment/idealcheckoutdirectebanking.tpl';
		}
	...
	public function confirm() 
	{
		...
		//$this->model_checkout_order->confirm($this->session->data['order_id'], $this->config->get('idealcheckoutdirectebanking_order_status_id'));
	}
	...
	{		
		...
		if(isset($this->session->data['order_id']))
		{
			...
			$this->language->load('payment/idealcheckoutdirectebanking');
			...
			$sTransactionSuccessUrl = $this->url->link('payment/idealcheckoutdirectebanking/callback'); // HTTPS_SERVER . 'index.php?route=payment/idealcheckoutdirectebanking/callback';
