			...
			<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
		        ...
		        <table id="mail" class="form">
		          ...
		          <tr>
		            ...
		            <td><select name="to">
		                <option value="1">Oude lijst Brian</option>
						<option value="2">Oude lijst Dunamis</option>
						<option value="3">Oude lijst Frohlich</option>
						<option value="4">Oude lijst Gaithers</option>
						<option value="5">Oude lijst Gospel7</option>
						<option value="6">Oude lijst Lifeshop</option>
						<option value="7">Oude lijst Meyer</option>
						<option value="8">Oude lijst Opwekking</option>
						<option value="9">Oude lijst Perlgim Kerken</option>
						<option value="10">Oude lijst Pelgrim Klanten</option>
						<option value="11">Oude lijst Pelgrim Pers</option>
						<option value="12">Oude lijst Pelgrim Scholen</option>
						<option value="13">Oude lijsten test</option>
		          ...
		          <tbody id="to-product" class="to">
					...
					<tr>
						...
						<td>
							...
							<?php } ?>
							<div style="display:none;"><p><?php echo $text_message_info; ?></p></div>
						</td>
					</tr>
		        </table>
		 	</form>
