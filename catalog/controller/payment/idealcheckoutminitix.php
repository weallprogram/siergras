...
class ControllerPaymentIdealcheckoutminitix extends Controller
{
	public function index() 
	{
		...
		$this->data['continue'] = $this->url->link('payment/idealcheckoutminitix/setup');

		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/idealcheckoutminitix.tpl')) 
		{
			$this->template = $this->config->get('config_template') . '/template/payment/idealcheckoutminitix.tpl';
		}
		else
		{
			$this->template = 'default/template/payment/idealcheckoutminitix.tpl';
		}
	...
	public function confirm() 
	{
		...
		//$this->model_checkout_order->confirm($this->session->data['order_id'], $this->config->get('idealcheckoutminitix_order_status_id'));
	}
	...
	{		
		...
		if(isset($this->session->data['order_id']))
		{
			...
			$this->language->load('payment/idealcheckoutminitix');
			...
			$sTransactionSuccessUrl = $this->url->link('payment/idealcheckoutminitix/callback'); // HTTPS_SERVER . 'index.php?route=payment/idealcheckoutminitix/callback';
