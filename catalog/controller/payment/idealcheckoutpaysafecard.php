...
class ControllerPaymentIdealcheckoutpaysafecard extends Controller
{
	public function index() 
	{
		...
		$this->data['continue'] = $this->url->link('payment/idealcheckoutpaysafecard/setup');

		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/idealcheckoutpaysafecard.tpl')) 
		{
			$this->template = $this->config->get('config_template') . '/template/payment/idealcheckoutpaysafecard.tpl';
		}
		else
		{
			$this->template = 'default/template/payment/idealcheckoutpaysafecard.tpl';
		}
	...
	public function confirm() 
	{
		...
		//$this->model_checkout_order->confirm($this->session->data['order_id'], $this->config->get('idealcheckoutpaysafecard_order_status_id'));
	}
	...
	{		
		...
		if(isset($this->session->data['order_id']))
		{
			...
			$this->language->load('payment/idealcheckoutpaysafecard');
			...
			$sTransactionSuccessUrl = $this->url->link('payment/idealcheckoutpaysafecard/callback'); // HTTPS_SERVER . 'index.php?route=payment/idealcheckoutpaysafecard/callback';
