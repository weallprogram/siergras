  ...
  <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
    <table class="form">
      <tr>
        ...
        <td colspan="2"><input type="text" name="sisowwg_merchantid" value="<?php echo $sisowwg_merchantid; ?>" />
          <br />
      ...
      <tr>
        ...
        <td colspan="2"><input type="text" name="sisowwg_merchantkey" value="<?php echo $sisowwg_merchantkey; ?>" />
          <br />
          <?php if ($error_username) { ?>
          <span class="error"><?php echo $error_username; ?></span>
          <?php } ?></td>
      ...
      <tr>
        ...
        <td colspan="2"><select name="sisowwg_status_success">
      ...
      <tr>
        ...
        <td colspan="2"><select name="sisowwg_testmode">
          ...
          <tr>
            ...
            <td colspan="2"><input type="text" name="sisowwg_total" value="<?php echo $sisowwg_total; ?>" /></td>
          </tr>          
          <tr>
            <td><?php echo $entry_totalmax; ?></td>
            <td colspan="2"><input type="text" name="sisowwg_totalmax" value="<?php echo $sisowwg_totalmax; ?>" /></td>
          </tr>          
        <tr>
          <td><?php echo $entry_geo_zone; ?></td>
          <td><select name="sisowwg_geo_zone_id">
      ...
      <tr>
        ...
        <td colspan="2"><select name="sisowwg_status">
      ...
      <tr>
        ...
        <td colspan="2"><input type="text" name="sisowwg_sort_order" value="<?php echo $sisowwg_sort_order; ?>" size="1" /></td>
      </tr>
      <tr>
