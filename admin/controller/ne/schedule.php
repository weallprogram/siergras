...
class ControllerNeSchedule extends Controller {
    ...
    public function index() {
        ...
        $this->language->load('ne/schedule');
    ...
    public function update() {
        $this->language->load('sale/contact');
        $this->language->load('ne/newsletter');
        $this->language->load('ne/schedule');
    ...
    private function form() {
        ...
        if (isset($this->request->post['text_message'])) {
            ...
            $this->data['text_message'] = $schedule_info['text_message'];
        } else {
        ...
        if (isset($this->request->post['text_message_products'])) {
            ...
            $this->data['text_message_products'] = $schedule_info['text_message_products'];
        } else {
        ...
        if (isset($this->request->post['customer_group_only_subscribers'])) {
            ...
            $this->data['customer_group_only_subscribers'] = $schedule_info['customer_group_only_subscribers'];
        } else {
        ...
        if (isset($this->request->post['only_selected_language'])) {
            ...
            $this->data['only_selected_language'] = $schedule_info['only_selected_language'];
        } else {
            $this->data['only_selected_language'] = '';
        }
