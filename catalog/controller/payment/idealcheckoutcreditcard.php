...
class ControllerPaymentIdealcheckoutcreditcard extends Controller
{
	public function index() 
	{
		...
		$this->data['continue'] = $this->url->link('payment/idealcheckoutcreditcard/setup');

		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/payment/idealcheckoutcreditcard.tpl')) 
		{
			$this->template = $this->config->get('config_template') . '/template/payment/idealcheckoutcreditcard.tpl';
		}
		else
		{
			$this->template = 'default/template/payment/idealcheckoutcreditcard.tpl';
		}
	...
	public function confirm() 
	{
		...
		//$this->model_checkout_order->confirm($this->session->data['order_id'], $this->config->get('idealcheckoutcreditcard_order_status_id'));
	}
	...
	{		
		...
		if(isset($this->session->data['order_id']))
		{
			...
			$this->language->load('payment/idealcheckoutcreditcard');
			...
			$sTransactionSuccessUrl = $this->url->link('payment/idealcheckoutcreditcard/callback'); // HTTPS_SERVER . 'index.php?route=payment/idealcheckoutcreditcard/callback';
