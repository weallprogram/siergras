  ...
  <div class="box">
    <div class="heading">
      ...
      <div class="buttons">
          ...
          <a id="button-send" onclick="send('index.php?route=ne/newsletter/send&token=<?php echo $token; ?>');" class="button"><span><?php echo $button_send; ?></span></a>
          <a onclick="$('input[name=spam_check]').val('1'); send('index.php?route=ne/newsletter/send&token=<?php echo $token; ?>');" class="button"><span><?php echo $button_check; ?></span></a>
        ...
        <table id="mail" class="form">
          ...
          <tbody id="to-product" class="to">
            ...
            <tr>
                ...
                <td>
                    <textarea name="text_message" style="width: 99%;" rows="10"><?php echo $text_message; ?></textarea>
                </td>
            </tr>
            <tr>
                <td><?php echo $entry_text_message_products; ?></td>
                <td>
                ...
                <label for="text_message_products_1"><?php echo $entry_yes; ?></label>
                <input type="radio"<?php echo $checked1; ?> id="text_message_products_1" name="text_message_products" value="1" />
                <label for="text_message_products_0"><?php echo $entry_no; ?></label>
                <input type="radio"<?php echo $checked0; ?> id="text_message_products_0" name="text_message_products" value="0" />
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
