...
<div class="box">
    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="form">
                ...
                <tr>
                    <td><?php echo $entry_show_savings; ?></td>
                    <td>
                    ...
                    <label for="product_show_savings_1"><?php echo $entry_yes; ?></label>
                    <input type="radio"<?php echo $checked1; ?> id="product_show_savings_1" name="product_show_savings" value="1" />
                    <label for="product_show_savings_0"><?php echo $entry_no; ?></label>
                    <input type="radio"<?php echo $checked0; ?> id="product_show_savings_0" name="product_show_savings" value="0" />
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td><?php echo $entry_savings_color; ?></td>
                    <td><input class="colorpicker_f" type="text" name="product_savings_color" value="<?php echo $product_savings_color; ?>" size="7" maxlength="7" /></td>
                </tr>
                <tr>
                    <td><?php echo $entry_savings_style; ?></td>
                    <td><input type="text" name="product_savings_style" size="100" value="<?php echo $product_savings_style; ?>" /></td>
                </tr>
                <tr>
                    <td><?php echo $entry_custom_css; ?></td>
                    <td><textarea name="custom_css" style="width: 99%;" rows="10"><?php echo $custom_css; ?></textarea></td>
                </tr>
                <tr>
                        ...
                        <?php foreach ($languages as $language) { ?>
                          <div id="language<?php echo $language['language_id']; ?>">
                            <table class="form">
                              ...
                              <tr>
                                <td><?php echo $entry_savings_text; ?></td>
                                <td><input type="text" name="savings_text[<?php echo $language['language_id']; ?>]" size="100" value="<?php echo isset($savings_text[$language['language_id']]) ? $savings_text[$language['language_id']] : ''; ?>" /></td>
                              </tr>
                                <tr>
                                ...
                                <tr>
                                  <td><?php echo $entry_text_message; ?></td>
                                  <td>
                                      <textarea name="text_message[<?php echo $language['language_id']; ?>]" style="width: 99%;" rows="10"><?php echo isset($text_message[$language['language_id']]) ? $text_message[$language['language_id']] : ''; ?></textarea>
                                  </td>
                                </tr>
                                <tr>
                                  <td>&nbsp;</td>
