    ...
    <div class="content">
      <form action="<?php echo $delete; ?>" method="post" enctype="multipart/form-data" id="form">
        <table class="list">
          ...
          <tbody>
            <?php if ($gift_promotions) { ?>
            <?php foreach ($gift_promotions as $gift_promotion) { ?>
            <tr>
              <td style="text-align: center;"><?php if ($gift_promotion['selected']) { ?>
                <input type="checkbox" name="selected[]" value="<?php echo $gift_promotion['gift_promotion_id']; ?>" checked="checked" />
                <?php } else { ?>
                <input type="checkbox" name="selected[]" value="<?php echo $gift_promotion['gift_promotion_id']; ?>" />
                <?php } ?></td>
              <td class="left"><?php echo $gift_promotion['name']; ?></td>
              <td class="left"><?php echo $gift_promotion['date_start']; ?></td>
              <td class="left"><?php echo $gift_promotion['date_end']; ?></td>
              <td class="left"><?php echo $gift_promotion['status']; ?></td>
              <td class="right"><?php foreach ($gift_promotion['action'] as $action) { ?>
