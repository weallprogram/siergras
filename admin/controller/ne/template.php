...
class ControllerNeTemplate extends Controller {
    ...
    public function index() {
        $this->language->load('ne/template');
    ...
    private function form() {
        ...
        $this->data['entry_show_savings'] = $this->language->get('entry_show_savings');
        ...
        $this->data['entry_savings_color'] = $this->language->get('entry_savings_color');
        $this->data['entry_savings_style'] = $this->language->get('entry_savings_style');
        ...
        $this->data['entry_savings_text'] = $this->language->get('entry_savings_text');
        ...
        if (isset($this->request->post['product_show_savings'])) {
            $this->data['product_show_savings'] = $this->request->post['product_show_savings'];
        } elseif (!empty($template_info)) {
            $this->data['product_show_savings'] = $template_info['product_show_savings'];
        } else {
            $this->data['product_show_savings'] = '0';
        }
        ...
        if (isset($this->request->post['product_savings_color'])) {
            $this->data['product_savings_color'] = $this->request->post['product_savings_color'];
        } elseif (!empty($template_info)) {
            $this->data['product_savings_color'] = $template_info['product_savings_color'];
        } else {
            $this->data['product_savings_color'] = '#999999';
        }

        if (isset($this->request->post['product_savings_style'])) {
            $this->data['product_savings_style'] = $this->request->post['product_savings_style'];
        } elseif (!empty($template_info)) {
            $this->data['product_savings_style'] = $template_info['product_savings_style'];
        } else {
            $this->data['product_savings_style'] = '';
        }

        if (isset($this->request->post['custom_css'])) {
            $this->data['custom_css'] = $this->request->post['custom_css'];
        } elseif (!empty($template_info)) {
            $this->data['custom_css'] = $template_info['custom_css'];
        } else {
        ...
        if (isset($this->request->post['savings_text'])) {
            $this->data['savings_text'] = $this->request->post['savings_text'];
        } elseif (!empty($template_info)) {
            $this->data['savings_text'] = $template_info['savings_text'];
        } else {
            $this->data['savings_text'] = array();
        }
        ...
        if (isset($this->request->post['text_message'])) {
            ...
            $this->data['text_message'] = $template_info['text_message'];
        } else {
            $this->data['text_message'] = array();
        }
